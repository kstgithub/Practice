package com.kst.funddemo.volley.listener;
...
public abstract class Listener<T> {
	...
	/** Inform when {@link com.tadu.android.volley.Request} execute is finish,
	...
	/** Inform when the {@link com.tadu.android.volley.Request} is truly cancelled. */
	public void onCancel() {}

	/**
	 * Inform When the {@link com.tadu.android.volley.Request} cache non-exist or expired,
	...
	/** Inform when {@link com.tadu.android.volley.Request} execute is going to retry. */
	public void onRetry() {}

	/**
	 * Inform when download progress change, this callback method only available
	 * when request was {@link com.kst.funddemo.volley.toolbox.FileDownloadRequest}.
	 */
