...
import com.kst.funddemo.volley.DefaultRetryPolicy;
import com.kst.funddemo.volley.NetworkResponse;
import com.kst.funddemo.volley.ParseError;
import com.kst.funddemo.volley.Response;
...
public class JsonArrayRequest extends JsonRequest<JSONArray> {
    ...
    public JsonArrayRequest(String url, Listener<JSONArray> listener) {
        ...
        setRetryPolicy(new DefaultRetryPolicy(DefaultRetryPolicy.DEFAULT_TIMEOUT_MS, 3, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
    }
